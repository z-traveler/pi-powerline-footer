...
export const PRESETS: Record<StatusLinePreset, PresetDef> = {
  default: {
    leftSegments: ["model", "shell_mode", "path", "git", "queue", "context_pct", "cache_read", "cost"],
    rightSegments: [],
  ...
  full: {
    leftSegments: ["hostname", "model", "shell_mode", "path", "git", "queue", "subagents"],
  ...
  nerd: {
    leftSegments: ["hostname", "model", "shell_mode", "path", "git", "queue", "session", "subagents"],
